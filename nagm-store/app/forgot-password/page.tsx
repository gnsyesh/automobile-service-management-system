      ...
      >
        <div className="text-center mb-6 sm:mb-8">
          <Link href="/" className="inline-flex flex-col items-center gap-2 mb-4 group">
            <div className="relative h-12 w-12 rounded-xl overflow-hidden bg-white/5 p-1 border border-[#D4A017]/30 shadow-md">
              <Image
            ...
            <div className="flex flex-col items-center text-center">
              <span className="text-sm font-black tracking-tight text-slate-900 dark:text-white">
                NEGM <span className="text-[#D4A017]">STORE</span>
              </span>
          ...
          <p className="text-xs text-slate-600 dark:text-gray-400 mt-1">Enter your registered email to receive reset instructions</p>
        </div>
        ...
        {submitted ? (
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <label className="block text-xs font-semibold text-slate-700 dark:text-gray-300 mb-1">Registered Email Address</label>
              <div className="relative flex items-center">
                <Mail className="absolute left-3.5 h-4 w-4 text-slate-400 dark:text-gray-500" />
                <input
                  type="email"
                  ...
                  required
                  className="w-full rounded-xl border border-slate-200 dark:border-[#2D2D2D] bg-slate-50 dark:bg-[#111111] py-3 pl-10 pr-4 text-xs text-slate-900 dark:text-white placeholder:text-slate-400 dark:placeholder:text-gray-500 focus:border-[#D4A017] focus:outline-none"
                />
              </div>
            </div>
            ...
            <div className="text-center pt-4">
              <Link href="/login" className="text-xs font-semibold text-slate-600 dark:text-gray-400 hover:text-slate-900 dark:hover:text-white flex items-center justify-center gap-1">
