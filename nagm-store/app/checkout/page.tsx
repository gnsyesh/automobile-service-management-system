...
export default function CheckoutPage() {
  ...
  const [walletPhone, setWalletPhone] =
    useState("01001234567");
  ...
  const handlePlaceOrder = async (
    ...
    try {
      ...
      /*
       * ==========================================
       * 4. CHECK REQUIRED SHIPPING INFORMATION
       * ==========================================
       */
      ...
      const orderId = `NS-${new Date().getFullYear()}-${Math.floor(
      ...
      const newOrder = {
        ...
        trackingNumber: `EG-TRK-${Math.floor(
    ...
    return (
      <main className="min-h-screen bg-slate-50 text-[#0F172A] dark:bg-[#111111] dark:text-gray-100 flex flex-col pt-24 sm:pt-32 pb-20 transition-colors duration-300">
        ...
        <div className="mx-auto max-w-xl px-4 text-center my-auto py-16">
          ...
          <Link
            href="/shop"
            className="mt-6 inline-flex items-center gap-2 rounded-xl bg-[#8B3A2E] px-6 py-3 text-xs font-bold text-white"
          >
            Return to Shop
          </Link>
          ...
          <div className="lg:col-span-4 space-y-6">
            ...
            <div className="rounded-3xl border border-[#D4A017]/30 bg-[#1B1B1B] p-6 backdrop-blur-xl shadow-2xl space-y-5">
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full flex items-center justify-center gap-2 py-4 rounded-xl bg-[#8B3A2E] font-black text-white text-sm hover:bg-[#a34436] transition shadow-2xl disabled:opacity-50 disabled:cursor-not-allowed"
              >
              ...
              <p className="text-[10px] text-center text-gray-500">
                You must be logged in and have a verified email
