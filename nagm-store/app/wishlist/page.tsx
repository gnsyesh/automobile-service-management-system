    ...
    return (
      <main className="min-h-screen bg-slate-50 text-[#0F172A] dark:bg-[#111111] dark:text-gray-100 flex flex-col pt-24 sm:pt-32 pb-20 transition-colors duration-300">
        ...
        <div className="mx-auto max-w-xl px-4 text-center my-auto py-16">
          <div className="flex h-20 w-20 items-center justify-center rounded-3xl bg-white dark:bg-[#1B1B1B] text-red-500 mx-auto mb-6 border border-slate-200 dark:border-[#2D2D2D] shadow-sm">
            <Heart className="h-10 w-10" />
          </div>
          <h1 className="text-2xl sm:text-3xl font-black text-slate-900 dark:text-white">Your Saved Wishlist is Empty</h1>
          <p className="text-sm text-slate-600 dark:text-gray-400 mt-2 max-w-md mx-auto">
  ...
  return (
    <main className="min-h-screen bg-slate-50 text-[#0F172A] dark:bg-[#111111] dark:text-gray-100 flex flex-col pt-24 sm:pt-32 pb-20 transition-colors duration-300">
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 w-full flex-1">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-slate-200 dark:border-[#2D2D2D] pb-6 mb-8">
          <div>
          ...
          <div className="flex flex-wrap items-center gap-2 sm:gap-3">
            ...
            <button
              ...
              className="flex items-center gap-2 rounded-xl border border-slate-200 dark:border-[#2D2D2D] bg-white dark:bg-[#1B1B1B] px-4 py-2.5 text-xs font-bold text-slate-600 dark:text-gray-400 hover:text-red-500 dark:hover:text-red-400 transition shadow-sm"
            >
