      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="absolute right-0 rtl:right-auto rtl:left-0 top-full mt-2 z-50 w-48 rounded-2xl border border-slate-200 dark:border-[#D4A017]/30 bg-white/95 dark:bg-[#1B1B1B]/95 p-1.5 backdrop-blur-2xl shadow-2xl overflow-hidden"
          >
