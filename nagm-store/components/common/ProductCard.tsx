    ...
    return (
      <>
        <motion.div
          ...
          className="group relative flex flex-col md:flex-row items-center gap-6 rounded-2xl border border-[#2D2D2D] bg-[#1B1B1B]/80 p-5 backdrop-blur-xl transition-all duration-300 hover:border-[#D4A017]/50 hover:shadow-[0_10px_30px_rgba(212,160,23,0.1)]"
        >
          {/* Image */}
          <div className="relative h-48 w-full md:w-56 shrink-0 overflow-hidden rounded-xl bg-[#111111]">
            <Image
          ...
          <div className="flex-1 flex flex-col justify-between w-full">
            ...
            {/* Price & Actions */}
            <div className="mt-5 flex flex-wrap items-center justify-between gap-4 pt-4 border-t border-[#2D2D2D]">
              <div>
              ...
              <div className="flex items-center gap-2">
                <button
                  ...
                  className={`p-2.5 rounded-xl border transition-all ${
                    isLiked
                      ...
                      : "border-[#2D2D2D] bg-[#111111] text-gray-400 hover:text-white hover:border-gray-500"
                  }`}
                  aria-label="Wishlist"
                >
                ...
                <button
                  ...
                  className="p-2.5 rounded-xl border border-[#2D2D2D] bg-[#111111] text-gray-400 hover:text-white hover:border-gray-500 transition-all"
                ...
                <button
                  ...
                  className="flex items-center gap-2 px-5 py-2.5 rounded-xl bg-[#8B3A2E] text-white font-semibold text-sm hover:bg-[#a34436] transition-all shadow-lg hover:shadow-[#8B3A2E]/20"
                >
  ...
  return (
    <>
      <motion.div
        ...
        className="group relative flex flex-col justify-between rounded-2xl border border-[#2D2D2D] bg-[#1B1B1B]/80 p-4 backdrop-blur-xl transition-all duration-300 hover:border-[#D4A017]/50 hover:shadow-[0_10px_35px_rgba(212,160,23,0.12)] hover:-translate-y-1"
      >
        {/* Top Badges & Heart */}
        <div className="relative h-56 w-full overflow-hidden rounded-xl bg-[#111111] p-4 flex items-center justify-center">
          {/* Badges */}
          ...
          <div className="absolute top-3 right-3 z-10 flex flex-col gap-2 opacity-90 group-hover:opacity-100 transition-opacity">
            <button
              ...
              className={`p-2 rounded-full border backdrop-blur-md transition-all shadow-md ${
                isLiked
                  ...
                  : "border-white/10 bg-[#111111]/80 text-gray-300 hover:text-white hover:bg-[#8B3A2E]"
              }`}
            ...
            <button
              onClick={() => setIsQuickViewOpen(true)}
              className="p-2 rounded-full border border-white/10 bg-[#111111]/80 text-gray-300 hover:text-white hover:bg-[#D4A017] hover:text-black transition-all shadow-md"
              aria-label="Quick View"
            >
        ...
        <div className="mt-4 flex-1 flex flex-col justify-between">
          <div>
            ...
            <Link href={`/product/${product.id}`} className="block group-hover:text-[#D4A017] transition-colors">
              <h3 className="text-sm font-bold text-white leading-tight line-clamp-2 h-10">
                {product.name}
              </h3>
            </Link>
          ...
          {/* Pricing & Add to Cart */}
          <div className="mt-4 pt-3 border-t border-[#2D2D2D] flex items-center justify-between gap-2">
            <div>
            ...
            <button
              onClick={() => addToCart(product)}
              className="flex items-center justify-center gap-1.5 rounded-xl bg-[#8B3A2E] px-3.5 py-2 text-xs font-bold text-white transition-all hover:bg-[#a34436] hover:shadow-[0_4px_15px_rgba(139,58,46,0.4)]"
            >
              <ShoppingBag className="h-4 w-4" />
              <span>Add</span>
            </button>
