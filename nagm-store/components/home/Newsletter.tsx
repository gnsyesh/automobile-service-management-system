...
export default function Newsletter() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (email) {
      showToast(
        language === "ar"
          ? "شكراً لاشتراكك في النادي الحصري لنجم ستور! تفقد بريدك الإلكتروني للحصول على كود الخصم."
          : "Thank you for subscribing! Check your inbox for exclusive VIP auto discounts.",
        "success"
      );
      setEmail("");
    }
  ...
  return (
    <section className="py-16 bg-slate-50 dark:bg-[#111111] border-t border-slate-200 dark:border-[#2D2D2D] transition-colors duration-300 overflow-hidden w-full max-w-full text-left rtl:text-right">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            <div className="lg:col-span-7">
              <span className="text-xs font-bold uppercase tracking-widest text-[#D4A017] flex items-center gap-1.5">
                <Mail className="h-4 w-4" /> {t("newsletter.badge")}
              </span>
