        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {features.map((feature, idx) => (
            <motion.div
              ...
              className="rounded-2xl border border-[#2D2D2D] bg-[#1B1B1B]/80 p-6 backdrop-blur-xl transition-all duration-300 hover:border-[#D4A017]/40 hover:-translate-y-1 shadow-lg"
            >
              <div className="flex h-14 w-14 items-center justify-center rounded-2xl bg-[#111111] border border-[#2D2D2D] mb-5">
                {feature.icon}
              </div>
