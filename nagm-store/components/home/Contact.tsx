    ...
    <section className="py-20 bg-slate-100 dark:bg-[#0A0A0A] border-t border-slate-200 dark:border-[#2D2D2D] transition-colors duration-300">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-6">
            ...
            <div className="mt-8 space-y-4">
              <div className="flex items-center gap-4 rounded-xl border border-slate-200 dark:border-[#2D2D2D] bg-white dark:bg-[#1B1B1B] p-4 shadow-sm">
                ...
                <div>
                  <div className="text-xs text-slate-500 dark:text-gray-400">Egypt Customer Support Hotline</div>
              ...
              <div className="flex items-center gap-4 rounded-xl border border-slate-200 dark:border-[#2D2D2D] bg-white dark:bg-[#1B1B1B] p-4 shadow-sm">
                ...
                <div>
                  <div className="text-xs text-slate-500 dark:text-gray-400">Email Support</div>
              ...
              <div className="flex items-center gap-4 rounded-xl border border-slate-200 dark:border-[#2D2D2D] bg-white dark:bg-[#1B1B1B] p-4 shadow-sm">
                ...
                <div>
                  <div className="text-xs text-slate-500 dark:text-gray-400">Headquarters & Central Warehouse</div>
                  <div className="text-sm font-bold text-slate-900 dark:text-white">Automotive Zone, 5th Settlement, New Cairo, Egypt</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="lg:col-span-6">
            <div className="rounded-3xl border border-slate-200 dark:border-[#D4A017]/30 bg-white dark:bg-[#1B1B1B] p-8 shadow-xl">
              <h3 className="text-xl font-bold text-slate-900 dark:text-white mb-6">Send Us A Direct Message</h3>
              <form onSubmit={(e) => e.preventDefault()} className="space-y-4">
                ...
                <div>
                  <label className="block text-xs font-semibold text-slate-700 dark:text-gray-300 mb-1">Inquiry / Car Details</label>
                  <textarea
                    rows={4}
